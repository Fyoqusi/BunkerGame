...
function generateCondition() {
  ...
  const resultElement = `
    ...
    <p>${catastrophe}</p>
    <h2>Бункер:</h2>
    <p>Вам доведеться пробути в бункері один рік, очікуючи, поки мине найнебезпечніший період катастрофи. У бункері є вода, їжа та спальні місця. Кожен раунд ви будете досліджувати свій бункер і поступово відкривати картки Бункера з новою інформацією. ${condition1} ${condition2} ${condition3}</p>
    `;
